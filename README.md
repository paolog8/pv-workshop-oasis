![docker image](https://github.com/paolog8/pv-workshop-oasis/actions/workflows/docker-publish.yml/badge.svg)


# paolog8's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of paolog8.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/paolog8/pv-workshop-oasis.git
    cd pv-workshop-oasis
    ```

    or

    ```sh
    curl-L -o pv-workshop-oasis.zip "https://github.com/paolog8/pv-workshop-oasis/archive/main.zip"
    unzip pv-workshop-oasis.zip
    cd pv-workshop-oasis
    ```
...
your `docker-compose.yaml` with `ghcr.io/paolog8/pv-workshop-oasis:main` for the services
...
```sh
docker pull ghcr.io/paolog8/pv-workshop-oasis/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/paolog8/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/paolog8/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/paolog8/pv-workshop-oasis/manifests/main": unauthorized`
